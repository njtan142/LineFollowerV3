...
/**
 * Line Following Mode - Implementation
 * All logic is now encapsulated in the LineFollower class
 */

// Create global line follower instance
 ...
 *
 * Simple wrapper that delegates to the LineFollower class.
 * All line following logic is now encapsulated in line_follower_class.h
 */
